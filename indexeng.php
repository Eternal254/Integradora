			...
			<div class="carousel-inner" role="listbox">
				<div class="item active">
				  ...
				  <div class="carousel-caption">
					<h3>S23 Ultra</h3>
					<p>Power redefined. Amazing Display</p>
				  </div>      
				</div>
				...
				<!-- Header -->
					<header id="header">
						<div class="inner">
							...
							<!-- Logo -->
								<a href="indexeng.php" class="logo">
					...
					<div class="container-fluid">
					  ...
					  <div class="collapse navbar-collapse" id="myNavbar">
						<ul class="nav navbar-nav navbar-right">
						  ...
						  <li><a href="loginanima/logineng.php">LOG IN</a></li>
						  <li class="dropdown">
        	<a class="dropdown-toggle" data-toggle="dropdown">LANGUAGE
				...
				<!-- Main -->
					...
					<div id="main">
						<div class="inner">
							<header>
								<h1>Cell phone consultation page</a>.</h1>
								<p>This is a page for you to find information about different mobile devices</p>
							</header>
							<section class="tiles">
								<?php
